...
bf = BF()
bf.set_options_by_paras(option_class='VanillaCall', option_position=-100, stock_index_code='000905.SH', start_date=date(2019,1,2), end_date=date(2019,3,29), K=4500, r=0.04, option_fee=1780800)
