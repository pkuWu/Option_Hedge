...
#牛市看涨差价
bull_call = Option_Contract().create_option_portfolio(option_class='BullCallSpread',option_position=1,
                                                      option_paras = {'stock_index_code':'000300.SH', 'start_date':date(2019,1,2),
                                                                      'end_date':date(2019,3,29), 'K_low':3000, 'K_high':3200,
                                                                      'r':0.04,'option_fee':1780800}) # 实例化且传入参数
...
#盒式差价
box = Option_Contract().create_option_portfolio(option_class='BoxSpread',option_position=1,
                                                option_paras={'stock_index_code':'000300.SH', 'start_date':date(2019,1,2),
                                                              'end_date':date(2019,3,29), 'K_low':3000, 'K_high':3200,
                                                              'r':0.04,'option_fee':1780800}) # 实例化且传入参数
...
#跨式组合
straddle = Option_Contract().create_option_portfolio(option_class='Straddle',option_position=1,
                                                     option_paras={'stock_index_code':'000300.SH', 'start_date':date(2019,1,2),
                                                                   'end_date':date(2019,3,29), 'K':3000, 'r':0.04,
                                                                   'option_fee':1780800}) # 实例化且传入参数
...
#宽跨式组合
strangle = Option_Contract().create_option_portfolio(option_class='Strangle',option_position=1,
                                                     option_paras={'stock_index_code':'000300.SH', 'start_date':date(2019,1,2),
                                                                   'end_date':date(2019,3,29), 'K_low':3000, 'K_high':3200,
                                                                   'r':0.04,'option_fee':1780800}) # 实例化且传入参数
...
#蝶式差价
butterfly_call = Option_Contract().create_option_portfolio(option_class='ButterflyCallSpread',option_position=1,
                                                           option_paras={'stock_index_code':'000300.SH',
                                                                         'start_date':date(2019,1,2),'end_date':date(2019,3,29),
                                                                         'K_low':3000, 'K_mid':3100, 'K_high':3200,
                                                                         'r':0.04,'option_fee':1780800}) # 实例化且传入参数
...
#日历差价
calendar_call = Option_Contract().create_option_portfolio(option_class='CalendarCallSpread',option_position=1,
                                                          option_paras={'stock_index_code':'000300.SH', 'start_date':date(2019,1,2),
                                                                        'end_date_before':date(2019,3,29), 'end_date_after':date(2019,6,28),
                                                                        'K':3300, 'r':0.04,'option_fee':1780800}) # 实例化且传入参数
...
ratio_call = Option_Contract().create_option_portfolio(option_class='RatioCallSpread',option_position=(-10),
                                                       option_paras={'stock_index_code':'000300.SH', 'start_date':date(2019,1,2),
                                                                     'end_date':date(2019,3,29), 'K_low':3000, 'K_high':3300,
                                                                     'r':0.04,'option_fee':1780800}) # 实例化且传入参数
