...
class VanillaCall(OptionBase):
    ...
    def calculate_greeks(self):
        ...
        self.greek_df.loc[:, 'cash_delta'] = self.greek_df.loc[:, 'delta']*self.greek_df.loc[:, 'stock_index_price']*self.notional/self.start_price
        self.greek_df.loc[:, 'cash_gamma'] = self.greek_df.loc[:, 'gamma']*np.power(self.greek_df.loc[:, 'stock_index_price'],2)*self.notional/self.start_price/100
