...
e.g. WW策略的delta带与动态调仓展示

![](../03_img/WW策略的delta带与动态调仓.jpg)
...
e.g. Zakamouline策略的delta带与动态调仓展示

![](../03_img/Zakamouline策略的delta带与动态调仓.jpg)
...
​	整体收益/名义本金、期货端收益/名义本金、期权端收益/名义本金、累积交易成本/名义本金、现金账户利息损益/名义本金

(6) 期货端收益拆解分析折线图

​	期货端收益/名义本金、指数收益/名义本金、基差收益/名义本金
